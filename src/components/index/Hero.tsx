      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-leaguespartan font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl text-text">
            Hey, I&apos;m Alex<span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="font-leaguespartan font-bold text-xl text-text brightness-50 italic sm:inline flex"> aka Bensonheimer992</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          <p className="font-leaguespartan font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg text-text">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["Ich bin ein kleiner Streamer und Developer"],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            <SocialIcon
              url="https://www.youtube.com/@bensonheimer992"
            ...
            />
            <SocialIcon
              url="https://discord.bencraft.xyz"
            ...
            />
            <SocialIcon
              url="https://namemc.com/profile/Bensonheimer992"
